  ...
  return (
    <div className="w-full order-1 md:w-1/2 md:order-2 md:border-l-2 md:px-10">
      ...
      <div className="flex items-center gap-5 mt-5 border-b-2">
        <InputFormPayment id="discount" label="Mã giảm giá" type="text" />
        <button className="w-2/5 md:w-1/5 p-4 bg-primary pointer-events-auto text-sm text-white rounded-lg mb-5 transition-all hover:opacity-70">
          Sử dụng
        </button>
      </div>
      ...
      <div className="w-full flex justify-between items-center py-5 border-b-2 md:border-0 text-text">
        ...
        <p className="text-2xl">
          <span className="mr-3 text-base opacity-70">VND</span>14,650,000₫
        </p>
      </div>
    </div>
  );
